import { r as registerInstance, h, c as createEvent, H as Host } from './core-21c026b7.js';
...
const Multiselect = class {
    constructor(hostRef) {
        ...
        this.onSelected = createEvent(this, "onSelected", 7);
    }
    /**
    ...
    render() {
        return (h(Host, { ref: el => this.multiselect = el }, h("div", { class: {
            ...
            } }), h("div", { class: "multiselect__placeholder" }, this.showSelectedBadge && this.selected.length > 0 ? this.tags : this.textSelected), this.isExpanded &&
