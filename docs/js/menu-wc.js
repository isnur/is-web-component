...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Is Web Component Documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter additional">
                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ? 'data-target="#additional-pages"'
                            ...
                            <span>Stencil documentation</span>
                            <span class="icon ion-ios-arrow-down"></span>
                        </div>
                        <ul class="links collapse " ${ isNormalMode ? 'id="additional-pages"' : 'id="xs-additional-pages"' }>
                                    <li class="link ">
                                        <a href="additional-documentation/is-alert.html" data-type="entity-link" data-context-id="additional">is-alert</a>
                                    </li>
                                    <li class="link ">
                                        <a href="additional-documentation/is-badge.html" data-type="entity-link" data-context-id="additional">is-badge</a>
                                    </li>
                                    <li class="link ">
                                        <a href="additional-documentation/is-modal.html" data-type="entity-link" data-context-id="additional">is-modal</a>
                                    </li>
                                    <li class="link ">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/ILabelTo.html" data-type="entity-link">ILabelTo</a>
                            </li>
                            <li class="link">
